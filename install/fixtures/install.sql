...
VALUES ('Welcome to phpVMS!',  'Thanks for installing and using phpVMS!<br /> Check out the <a href="https://forum.phpvms.net/" target="_new">forums</a> for help and information on getting started on your VA.<br /><br />This is just a starter skin - customize yours completely. This is just a basic, barebones example of what a skin is and how it works. Check out the crystal folder in the lib/skins directory. Make your own copy and fiddle around. For help, check out the forum, and skinning docs. The <a href="http://forum.phpvms.net" target="_blank">forums</a> are filled with plenty of helpful people for any questions you may have.<br /><br />Good luck!', NOW(), 'phpVMS Installer');

INSERT INTO `phpvms_airports` (`id`, `icao`, `iata`, `name`, `city`, `country`, `region`, `tz`, `elevation`, `lat`, `lng`, `hub`, `fuelprice`, `chartlink`) VALUES
(1, 'KJFK', 'JFK', 'John F Kennedy International Airport', 'New York', 'US', 'US-NY', 'America/New_York', '13', 40.6398, -73.7789, 1, 0, '');
